...
- **9 - Plot results.ipynb**: this notebook generates the plots from the CSVs generated by the previous notebook. Please note that these are the plots shown in the Figures 6, 7, 8, 9, and 10 in Section 6.
